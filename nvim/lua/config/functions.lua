...
function _G.hledger_update()
  ...
  os.execute(
    "/usr/local/bin/hledger -f /Users/guido/.finance/all.journal accounts | /usr/local/bin/python3.11 /Users/guido/.finance/.src/scripts/filter-account.py > /Users/guido/.finance/.src/completion-source/accounts"
  )
